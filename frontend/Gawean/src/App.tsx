    ...
    <>
      ...
      <section className="hero">
        ...
        <h1>
          Jasa Mahasiswa Asli,
          <br />
          <em>Harga Mahasiswa</em>
        </h1>
        <p>
          Gawean menghubungkan mahasiswa yang butuh jasa desain, coding,
          tulisan, sampai edit video, dengan mahasiswa lain yang punya skill dan
          waktu luang.
        </p>
        ...
        <div className="foot-grid">
          <div>
            ...
            <p className="foot-desc">
              Platform jasa mahasiswa untuk mahasiswa. Kerja lebih dekat, harga
              lebih masuk akal.
            </p>
          </div>
